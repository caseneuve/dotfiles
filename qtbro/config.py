...
# Last update: 2019-05-31, 12:14:34 @toshiba
...
config.bind('<Ctrl-s>', 'open -t file:///home/piotr/.dotfiles/qtbro/qtb-search-helper.html')
...
config.bind('dA', 'hint links fill :spawn st -c YTBDWL -e youtube-dl --extract-audio --audio-format mp3 --output "muz/qtb/%(title)s.%(ext)s" {hint-url}')
config.bind('dE', 'spawn st -c YTBDWL -e youtube-dl --write-srt --sub-lang en --output "wid/qtb/%(title)s.%(ext)s" {url}')
config.bind('dS', 'spawn st -c YTBDWL -e youtube-dl --write-auto-sub --skip-download --output "wid/qtb/%(title)s.%(ext)s" {url}')
config.bind('dV', 'hint links fill :spawn st -e youtube-dl --output "wid/qtb/%(title)s.%(ext)s" {hint-url}')
config.bind('da', ':spawn st -c YTBDWL -e youtube-dl --extract-audio --audio-format mp3 --output "muz/qtb/%(title)s.%(ext)s" {url}')
config.bind('ds', 'spawn st -c YTBDWL -e youtube-dl --write-auto-sub --output "wid/qtb/%(title)s.%(ext)s" {url}')
