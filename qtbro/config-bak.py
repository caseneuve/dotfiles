...
c.colors.statusbar.command.private.bg = 'grey' #purple
...
## Type: QssColor
c.colors.statusbar.normal.fg = '#e1e1e0' #white
...
## Type: QssColor
c.colors.statusbar.private.bg = 'grey' ##666666
...
## Type: QssColor
c.colors.statusbar.progress.bg = '#e1e1e0' #white #2980b9
...
## Type: QssColor
c.colors.statusbar.url.fg = '#e1e1e0' #white
#c.colors.statusbar.url.fg = 'black'

# >> Foreground color of the URL in the statusbar for hovered links.
## Type: QssColor
c.colors.statusbar.url.hover.fg = '#ffda79' #aqua
#c.colors.statusbar.url.hover.fg = 'blue'

# >> Foreground color of the URL in the statusbar on successful load
# (http).
## Type: QssColor
c.colors.statusbar.url.success.http.fg = '#e1e1e0' #orange

# >> Foreground color of the URL in the statusbar on successful load
# (https).
## Type: QssColor
c.colors.statusbar.url.success.https.fg = '#e1e1e0' #lime
...
## Type: Bool
# 15/09/2018: option has been removed from qtb
...
# >> mpv bindings
config.bind(
    ';v', 'hint links fill :spawn i3-msg "exec --no-startup-id ~/.dotfiles/bin/queuempv {hint-url}"')
config.bind(';V', ':spawn i3-msg "exec --no-startup-id ~/bin/queuempv {url}"')
config.bind(
    ';a', 'hint links fill :spawn i3-msg "exec --no-startup-id ~/.dotfiles/bin/queuempv --no-video {hint-url}"')
config.bind(
    ';A', ':spawn i3-msg "exec --no-startup-id ~/bin/queuempv --no-video {url}"')
# >> d → DOWNLOAD bindings
# >> download video
config.bind(
    'dv', 'spawn st -e youtube-dl --output "wid/qtb/%(title)s.%(ext)s" {url}')
config.bind(
