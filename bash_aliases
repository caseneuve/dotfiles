...
# Last update: 11.04.18, 21:33:41 @manjaroi3
...
alias nb='i3-msg -q "exec --no-startup-id $TERMINAL -e newsboat"'
alias nbb='i3-msg -q "workspace 9; exec --no-startup-id $TERMINAL -e newsboat"'
