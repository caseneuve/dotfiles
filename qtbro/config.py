...
config.bind(';V', 'spawn st -e youtube-dl --output "Wideo/qtb/%(title)s.%(ext)s" {url}')
config.bind(';A', 'hint links fill :spawn st -e youtube-dl --extract-audio --audio-format mp3 --output "home/piotr/Muzyka/qtb/%(title)s.%(ext)s" {hint-url}')
...
config.bind('Sm', 'open -t ;; set-cmd-text -s :messages')
