 ...
 */
static char *font = "Meslo LG M:size=10.5:antialias=true:autohint=true";
...
static Shortcut shortcuts[] = {
	...
	{ MODKEY|ShiftMask,     XK_Prior,       xzoom,          {.f = +1} }, /* = Alt+Shift+PgUp */
	{ MODKEY|ShiftMask,     XK_Next,        xzoom,          {.f = -1} }, /* = Alt+Shift+PgDwn */
	...
	{ MODKEY,               XK_Control_L,   iso14755,       {.i =  0} },
  	{ MODKEY|ShiftMask,     XK_o,		swapcolors,	{.i =  0} },
